...
@section('content')
<form action="{{ url('dashboard/datosproyectos')}}" method="POST" enctype="multipart/form-data">
    {{ csrf_field() }}
    ...
    <div class="mb-3 mt-2">
        <div class="mb-3 ">
            ...
            <input type="text" name="servicio1" id="servicio1" class="form-control" value="" required >
        </div>
    </div>
    <br>
    <div class="mb-3 mt-2">
