...
<form action="{{ url('dashboard/datosproyectos/'. $datosproyectos->id)}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-3 mt-4">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="nombre" id="nombre" class="form-control" value="{{$datosproyectos->nombre}}" required >
        </div>
    </div>
    <br>
    ...
    <div class="mb-3 mt-2">
        <div class="mb-3 ">
            ...
            <input type="text" name="servicio1" id="servicio1" class="form-control " required
    ...
    <a href="/dashboard/datosproyectos" class="btn btn-secondary">Volver</a>
